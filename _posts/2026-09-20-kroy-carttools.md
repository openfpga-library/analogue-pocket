...
layout: post
author: kroy
title: kroy.CartTools - 0.9999.20260920.1
date: 2026-09-20
...
and Game Boy Advance cartridges through the Pocket's cartridge slot, and dump
Game Gear and Atari Lynx ROMs through the official Analogue adapters.
...
Restore is hardware-verified on Pokemon Silver (MBC3, 32 KiB),
Dragon Warrior III (MBC5, 32 KiB) and Shadowgate Classic (MBC5, 8 KiB).
MBC1 8 KiB and other MBC3 and MBC5 cartridges are implemented but untested.
