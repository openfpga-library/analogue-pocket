...
layout: post
author: plasticbugs
title: plasticbugs.bbcmicro - 0.3.0
date: 2026-09-22
...
SIDEWAYS RAM
* Fits a 64K board: banks 4 to 7,
  kept across BREAK
* Banks 4-7 are where software of
  the period looks. A bare Model B
  cannot reach them at all
* Switch with STA &FE30 from a
  routine in main RAM, with SEI;
  BASIC cannot, it is in bank 3
* No *SRLOAD: that is a Master
  command, this is a Model B
